...
* 상세 페이지 상단의 ‘리뷰 작성’ 섹션에서 별점(1\~5점)을 선택하고, 자유롭게 한 줄 이상의 리뷰 내용을 입력합니다.
* 작성 완료 후 ‘제출’ 버튼을 누르면 나의 리뷰로 등록됩니다.

### 5. 리뷰 관리 (내 리뷰 확인, 수정, 삭제)

* 우측 상단의 프로필 아이콘을 클릭하여 ‘마이 페이지’로 이동합니다.
* 마이 페이지에서 내가 작성한 모든 리뷰 목록을 확인할 수 있습니다.
* 각 리뷰 옆의 ‘수정’ 또는 ‘삭제’ 버튼을 클릭하여 작성된 리뷰를 바로 수정하거나 삭제할 수 있습니다.

### 6. 프로필 관리

* 마이 페이지 내 ‘프로필 설정’ 메뉴에서 닉네임, 프로필 사진, 간단한 소개글을 변경할 수 있습니다.
* 변경사항 입력 후 ‘저장’ 버튼을 누르면 내 정보가 업데이트됩니다.
